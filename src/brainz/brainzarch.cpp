...
// 			as.dendriteBranch = randgen->Instance()->get( 1, ArchNeurons[parentneuron].dendridicBranches );
	...
	int BrainzArch::findSensorNeuron( unsigned int id )
	{
...
// 		cerr << "brain findSensorNeuron error for id: " << id << endl;
	...
	int BrainzArch::findMotorNeuron( unsigned int id )
	{
...
// SERIALIZE FUNC
	...
	void BrainzArch::setArch(string* content)
	{
